...
class NavBar extends Component {
  ...
  render() {
    ...
    toggleBtnClasses[styles.circleChanges] = true;
        ...
        <div className={styles.topReverse} >
          <div className={styles.left} style={{ 'display': 'flex', alignItems: 'center' }}>
            {isExpanded && document.dir === 'ltr'
              && <Icon onClick={this.handleToggleUserList} iconName="right_arrow" className={styles.arrowRight} style={{ 'position': 'relative' }} />}
            ...
            />
            {!isExpanded && document.dir === 'ltr'
              && <Icon onClick={this.handleToggleUserList} iconName="left_arrow" className={styles.arrowLeft} style={{ 'position': 'relative', 'order': '-1', marginRight: '4px' }} />}
            {isExpanded && document.dir === 'rtl'
              && <Icon onClick={this.handleToggleUserList} iconName="left_arrow" className={styles.arrowLeft} style={{ 'position': 'relative', 'order': '-1', marginRight: '4px' }} />}
          </div>
